...
若你已部署到 Zeabur 或其他平台,可在本段補上公開網址。
...
| 上市/上櫃盤中即時現價 | Yahoo 台股頁 `tw.stock.yahoo.com`(真即時最後成交價),fallback 到 mis.twse、再到 Yahoo query1 chart |
...
- 盤中即時現價:tw.stock.yahoo.com 個股頁(備援:mis.twse.com.tw、Yahoo query1 chart)
